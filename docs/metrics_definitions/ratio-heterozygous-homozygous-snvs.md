...
- **Description:** The ratio of heterozygous and homozygous variant of type SNVs in [VCF](References.md#vcf-format), only in [autosomal regions](terminologies.md#autosomes-non-gap-regions), [high quality variants](terminologies.md#high-quality-variants).
