...
- **Functionally equivalent implementations:**
  ...
  - [Candidate] [argodnaalnqc v1.0.0](#argo)
...
- **Functionally equivalent implementations:**
  - Criteria: NA
  - [Candidate] [DRAGEN v3.7.6](#dragen). Extracted from [sample-id].mapping_metrics.csv, key name: `MAPPING/ALIGNING SUMMARY,,Estimated sample contamination`
  - [Candidate] [argodnaalnqc v1.0.0](#argo)
