...
- **ID:** count_snvs
- **Description:** The number of variant type SNVs in VCF, only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants).
...
- **ID:** count_insertions
- **Description:** The number of variant type indels only insertions in VCF, only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants). 
...
- **ID:** count_deletions
- **Description:** The number of variant type indels only deletions in VCF, only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants).
