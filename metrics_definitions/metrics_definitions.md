...
- **ID:** count_snvs
- **Description:** The number of variant type SNVs in [VCF](#VCF), only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants).
...
- **ID:** count_insertions
- **Description:** The number of variant type indels only insertions in [VCF](#VCF), only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants). 
...
- **ID:** count_deletions
- **Description:** The number of variant type indels only deletions in [VCF](#VCF), only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants).
...
- **Description:** The ratio between number of insertion and deletion in [VCF](#VCF), only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants).
...
- **Description:** The ratio of heterozygous and homozygous variant type indels in [VCF](#VCF), only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants).
...
- **Description:** The ratio of transitions and transversions of bi-allelic SNVs in [VCF](#VCF), only in [autosomal regions](#Autosomes-non-gap-regions) [high quality variants](#High quality variants).
